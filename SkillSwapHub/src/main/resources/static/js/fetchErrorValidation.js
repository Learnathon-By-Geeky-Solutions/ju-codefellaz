 async function submitRegistrationForm(event) {
    ...
    try {
        ...
        showMessage("Provide valid data, try again.", "error");
...
//         } else if (data.responseCode === "E000102") {
//             // Capture and format validation errors
//             let errorMessages = [];
//             for (let field in data.data) {
//                 errorMessages.push(`${field.toUpperCase()}: ${data.data[field]}`);
//             }
//             showToast(errorMessages.join("<br>"), "error");
//         } else {
//             showToast(data.responseMessage || "An unexpected error occurred.", "error");
//         }
//
//     } catch (error) {
